...
const projects = [
  {
    id: 1,
    name: "SudoResume",
    technologies: ["Next.js", "Tailwind", "PostgreSQL", "AI"],
    liveUrl: "https://sudoresume.com",
    sourceUrl: null,
    type: "Web App",
    availability: ["Live"],
  },
  {
    id: 2,
    name: "Git Insight",
    technologies: ["Next.js", "TypeScript", "Tailwind", "tRPC"],
    liveUrl: "https://gitinsight.dev",
    sourceUrl: "https://github.com/kelson/git-insight",
    type: "Web App",
